...
import 'package:toyland_mobile/x_res/app_text_style.dart';
...
class AppThemes {
  ...
  static String BeVietnamPro = "BeVietnamPro";

  static String _fontFamily = BeVietnamPro;
  ...
  static final ThemeData _lightTheme = ThemeData(
    ...
    primaryColor: MyColor.PRIMARY_100,
    scaffoldBackgroundColor: MyColor.LIGHT_BACKGROUND_COLOR,
    floatingActionButtonTheme: FloatingActionButtonThemeData(
      backgroundColor: MyColor.PRIMARY_100,
    ),
    appBarTheme: AppBarTheme(
      color: MyColor.PRIMARY_100,
    ...
    colorScheme: ColorScheme.light(
        ...
        primary: MyColor.PRIMARY_100, secondary: MyColor.ACCENT_COLOR),
  );
